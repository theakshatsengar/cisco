...
export default function Chat() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { sender: 'cisco', text: data.response }]);
    } catch (err) {
      setMessages((prev) => [...prev, { sender: 'cisco', text: 'Error talking to AI.' }]);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <section className="min-h-screen flex flex-col">
      ...
      <form
        ...
        className="px-4 py-2 border-t border-neutral-800"
      >
